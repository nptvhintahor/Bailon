...
class BankingVisualizer:
    ...
    # --- BIỂU ĐỒ 1: TỔNG TIỀN THEO THÁNG (ĐẶT CHỮ TRÊN/DƯỚI XEN KẼ) ---
    def draw_monthly_trend_premium(self):
        ...
        # Ghi số tiền: Tháng 2,4,6,9,11 nằm dưới, các tháng khác nằm trên
        ...
        for i, row in monthly_data.iterrows():
            ...
            if m_num in bottom_months:
                # Đặt bên dưới đường kẻ
                y_pos = val - (max_val * 0.05)
                v_align = 'top'
            else:
                # Đặt bên trên đường kẻ
        ...
        self.ax.set_title('PHÂN TÍCH BIẾN ĐỘNG DÒNG TIỀN HÀNG THÁNG (2019)', 
    ...
    def draw_state_lollipop(self):
        ...
        self.ax.set_title('TOP 15 TIỂU BANG CÓ TỔNG CHI TIÊU CAO NHẤT (2019)', 
