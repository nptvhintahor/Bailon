...
class BankingVisualizer:
    def __init__(self, df_2020):
        ...
        # Danh sách slide: 1. Tháng (2020), 2. Tiểu bang (2020)
    ...
    # --- BIỂU ĐỒ 1: TỔNG TIỀN THEO THÁNG (2020) ---
    def draw_monthly_trend_premium(self):
        ...
        # Ghi số tiền xen kẽ: Tháng 2,4,6,9,11 nằm dưới, các tháng khác nằm trên
        ...
        self.ax.set_title('PHÂN TÍCH BIẾN ĐỘNG DÒNG TIỀN HÀNG THÁNG (2020)', 
    ...
    # --- BIỂU ĐỒ 2: TIỂU BANG (LOLLIPOP - 2020) ---
    def draw_state_lollipop(self):
        ...
        self.ax.set_title('TOP 15 TIỂU BANG CÓ TỔNG CHI TIÊU CAO NHẤT (2020)', 
