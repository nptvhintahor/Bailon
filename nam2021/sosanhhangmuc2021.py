...
class BankingVisualizer:
    ...
    # --- BIỂU ĐỒ 1: TOP 15 DANH MỤC (2021) ---
    def draw_merchant_slide(self):
        ...
        self.ax.set_title("1. TOP 15 DANH MỤC KINH DOANH (2021)", fontsize=14, fontweight='bold', pad=20)
    ...
    # --- BIỂU ĐỒ 2: 5 LOẠI TÀI KHOẢN (2021) ---
    def draw_account_slide(self):
        ...
        self.ax.set_title("2. SO SÁNH 5 LOẠI TÀI KHOẢN (2021)", fontsize=14, fontweight='bold', pad=20)
    ...
    # --- BIỂU ĐỒ 3: 6 PHƯƠNG THỨC THANH TOÁN (2021) ---
    def draw_method_slide(self):
        ...
        self.ax.set_title("3. TỶ LỆ PHƯƠNG THỨC THANH TOÁN (2021)", fontsize=14, fontweight='bold', pad=20)
        self.ax.set_ylabel("Số lượng giao dịch")
...
def run_banking_analysis(file_path):
    try:
        ...
        # Sửa lỗi format specifier ở đây
        print(f">>> Đang hiển thị trực quan hóa cho {len(df_2021):,} giao dịch năm 2021...")
        BankingVisualizer(df_2021)
