...
class BankingVisualizer2021:
    def __init__(self, df_2021):
        ...
        # Danh sách slide: 1. Tháng (2021), 2. Tiểu bang (2021)
    ...
    # --- BIỂU ĐỒ 1: TỔNG TIỀN THEO THÁNG (2021) ---
    def draw_monthly_trend_premium(self):
        ...
        self.ax.set_title('PHÂN TÍCH BIẾN ĐỘNG DÒNG TIỀN HÀNG THÁNG (2021)', 
    ...
    # --- BIỂU ĐỒ 2: TIỂU BANG (LOLLIPOP - 2021) ---
    def draw_state_lollipop(self):
        ...
        self.ax.set_title('TOP 15 TIỂU BANG CÓ TỔNG CHI TIÊU CAO NHẤT (2021)', 
...
def run_analysis(file_path):
    try:
        ...
        print(f">>> Đang khởi chạy trực quan hóa cho {len(df_2021):,} giao dịch năm 2021...")
        BankingVisualizer2021(df_2021)
