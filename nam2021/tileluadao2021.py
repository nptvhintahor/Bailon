...
class FraudVisualizer2021:
    def __init__(self, df_2021):
        self.df = df_2021
        self.current_slide = 0
        
        # Danh sách các hàm vẽ biểu đồ cho năm 2021
        self.slides = [
    ...
    # --- BIỂU ĐỒ 1: THỐNG KÊ SỐ LƯỢNG (2021) ---
    def draw_fraud_count(self):
        ...
        self.ax.set_title("1. SỐ LƯỢNG GIAO DỊCH AN TOÀN VS LỪA ĐẢO (2021)", fontsize=15, fontweight='bold', pad=20)
        self.ax.set_ylabel("Số lượng giao dịch")
        self.ax.spines['top'].set_visible(False)
        self.ax.spines['right'].set_visible(False)

    # --- BIỂU ĐỒ 2: TỔNG SỐ TIỀN (2021) ---
    def draw_fraud_amount(self):
        ...
        self.ax.set_title("2. TỶ TRỌNG TỔNG GIÁ TRỊ GIAO DỊCH (2021)", fontsize=15, fontweight='bold')

    # --- BIỂU ĐỒ 3: TỶ LỆ THEO TIỂU BANG (2021) ---
    def draw_state_fraud(self):
        ...
        self.ax.set_title("3. TỶ LỆ (%) GIAO DỊCH LỪA ĐẢO THEO TIỂU BANG (2021)", fontsize=15, fontweight='bold', pad=20)
        self.ax.set_xlabel("Phần trăm (%)")
        self.ax.set_xlim(0, 100)
        self.ax.legend(loc='lower center', bbox_to_anchor=(0.5, -0.2), ncol=2)

    # --- BIỂU ĐỒ 4: BIẾN ĐỘNG THEO THÁNG (2021) ---
    def draw_monthly_fraud(self):
        ...
        self.ax.set_title("4. BIẾN ĐỘNG GIAO DỊCH THEO THÁNG (2021)", fontsize=15, fontweight='bold', pad=20)
...
def run_analysis(file_path):
    try:
        ...
        print(f">>> Đang khởi chạy phân tích gian lận cho {len(df_2021):,} giao dịch năm 2021...")
        FraudVisualizer2021(df_2021)
