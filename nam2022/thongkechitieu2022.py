...
class MoneyVisualizer2022:
    def __init__(self, df_2022):
        ...
        # Danh sách các hàm vẽ biểu đồ dòng tiền cho năm 2022
        self.slides = [
    ...
    def update_navigation(self):
        """Ẩn/Hiện nút bấm theo logic vị trí slide"""
    ...
    # --- BIỂU ĐỒ 1: TỔNG TIỀN THEO 15 HẠNG MỤC (2022) ---
    def draw_amount_by_category(self):
        ...
        self.ax.set_title("1. TỔNG TIỀN CHI TIÊU THEO 15 HẠNG MỤC (2022)", fontsize=14, fontweight='bold')
    ...
    # --- BIỂU ĐỒ 2: TỔNG TIỀN THEO 5 LOẠI TÀI KHOẢN (2022) ---
    def draw_amount_by_account(self):
        ...
        self.ax.set_title("2. TỔNG TIỀN THEO 5 LOẠI TÀI KHOẢN (2022)", fontsize=14, fontweight='bold')
    ...
    # --- BIỂU ĐỒ 3: TỔNG TIỀN THEO 6 PHƯƠNG THỨC (2022) ---
    def draw_amount_by_method(self):
        ...
        self.ax.set_title("3. TỔNG TIỀN THEO 6 PHƯƠNG THỨC THANH TOÁN (2022)", fontsize=14, fontweight='bold')
...
def run_money_analysis(file_path):
    try:
        ...
        print(f">>> Đang khởi chạy phân tích dòng tiền cho {len(df_2022):,} giao dịch năm 2022...")
        MoneyVisualizer2022(df_2022)
