...
class BankingVisualizer2022:
    ...
    # --- BIỂU ĐỒ 1: TỔNG TIỀN THEO THÁNG (2022) ---
    def draw_monthly_trend_premium(self):
        ...
        # Ghi số tiền xen kẽ trên dưới để tránh đè chữ
        ...
        self.ax.set_title('PHÂN TÍCH BIẾN ĐỘNG DÒNG TIỀN HÀNG THÁNG (2022)', 
    ...
    # --- BIỂU ĐỒ 2: TIỂU BANG LOLLIPOP (2022) ---
    def draw_state_lollipop(self):
        ...
        self.ax.set_title('TOP 15 TIỂU BANG CÓ TỔNG CHI TIÊU CAO NHẤT (2022)', 
...
def run_analysis(file_path):
    try:
        ...
        print(f">>> Đang khởi chạy trực quan hóa cho {len(df_2022):,} giao dịch năm 2022...")
