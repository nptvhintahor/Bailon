...
class BankingVisualizer:
    ...
    def draw_merchant_slide(self):
        ...
        self.ax.set_title("1. TOP 15 DANH MỤC KINH DOANH (2023)", fontsize=14, fontweight='bold', pad=20)
    ...
    def draw_account_slide(self):
        ...
        self.ax.set_title("2. SO SÁNH 5 LOẠI TÀI KHOẢN (2023)", fontsize=14, fontweight='bold', pad=20)
    ...
    def draw_method_slide(self):
        ...
        self.ax.set_title("3. TỶ LỆ PHƯƠNG THỨC THANH TOÁN (2023)", fontsize=14, fontweight='bold', pad=20)
        self.ax.set_ylabel("Số lượng giao dịch")
...
def run_banking_analysis(file_path):
    try:
        ...
        # Lọc dữ liệu năm 2023 và bỏ các dòng lỗi ngày tháng
