...
class TimeAnalysisVisualizer:
    ...
    # --- BIỂU ĐỒ 1: TỔNG QUAN GIỜ GIAO DỊCH TRONG NĂM 2023 ---
    def draw_hourly_distribution(self):
        ...
        self.ax.set_title("1. PHÂN BỔ SỐ LƯỢNG GIAO DỊCH THEO KHUNG GIỜ (2023)", fontsize=15, fontweight='bold', pad=20)
    ...
    # --- BIỂU ĐỒ 2: HEATMAP THÁNG VS GIỜ (2023) ---
    def draw_monthly_hourly_heatmap(self):
        ...
        self.ax.set_title("2. BIỂU ĐỒ TƯƠNG QUAN GIỮA THÁNG VÀ GIỜ GIAO DỊCH (2023)", fontsize=15, fontweight='bold', pad=20)
        self.ax.set_xlabel("Giờ trong ngày", fontsize=12)
        self.ax.set_ylabel("Tháng trong năm", fontsize=12)
        
        # Cập nhật nhãn trục Y dựa trên các tháng thực tế có trong dữ liệu
...
def run_analysis(file_path):
    try:
        ...
        # Lọc dữ liệu duy nhất cho năm 2023
        ...
        TimeAnalysisVisualizer(df_2023)
