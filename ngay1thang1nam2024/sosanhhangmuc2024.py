...
class BankingVisualizer:
    ...
    # --- BIỂU ĐỒ 1: TOP 15 DANH MỤC (2024) ---
    def draw_merchant_slide(self):
        ...
        self.ax.set_title("1. TOP 15 DANH MỤC KINH DOANH (2024)", fontsize=14, fontweight='bold', pad=20)
    ...
    # --- BIỂU ĐỒ 2: 5 LOẠI TÀI KHOẢN (2024) ---
    def draw_account_slide(self):
        ...
        self.ax.set_title("2. SO SÁNH 5 LOẠI TÀI KHOẢN (2024)", fontsize=14, fontweight='bold', pad=20)
    ...
    # --- BIỂU ĐỒ 3: 6 PHƯƠNG THỨC THANH TOÁN (2024) ---
    def draw_method_slide(self):
        ...
        self.ax.set_title("3. TỶ LỆ PHƯƠNG THỨC THANH TOÁN (2024)", fontsize=14, fontweight='bold', pad=20)
        self.ax.set_ylabel("Số lượng giao dịch")
...
def run_banking_analysis(file_path):
    try:
        ...
        # Lọc dữ liệu năm 2024 và bỏ các dòng lỗi ngày tháng
