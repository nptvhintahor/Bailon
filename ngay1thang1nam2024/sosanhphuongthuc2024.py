...
class CategoryComparisonVisualizer:
    def __init__(self, df_2024):
        ...
        # Lấy danh sách Top 15 danh mục chi tiêu để dùng chung cho cả 2 biểu đồ năm 2024
    ...
    def draw_cat_vs_account(self):
        """Biểu đồ 4: Hạng mục chi tiêu vs Loại tài khoản (2024)"""
        ...
        self.ax.set_title("BIỂU ĐỒ 4: PHÂN TÍCH LOẠI TÀI KHOẢN THEO HẠNG MỤC (2024)", fontsize=14, fontweight='bold')
    ...
    def draw_cat_vs_method(self):
        """Biểu đồ 5: Hạng mục chi tiêu vs Phương thức thanh toán (2024)"""
        ...
        self.ax.set_title("BIỂU ĐỒ 5: PHÂN TÍCH PHƯƠNG THỨC THANH TOÁN THEO HẠNG MỤC (2024)", fontsize=14, fontweight='bold')
...
def run_analysis(file_path):
    try:
        ...
        # Lọc dữ liệu duy nhất trong năm 2024
        df_2024 = df[df['transaction_date'].dt.year == 2024].copy()
        
        if df_2024.empty:
            print("Thông báo: Dữ liệu năm 2024 trống hoặc không tìm thấy.")
            return

        CategoryComparisonVisualizer(df_2024)
