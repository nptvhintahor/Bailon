...
class MoneyVisualizer:
    def __init__(self, df_2024):
        ...
        # Danh sách các hàm vẽ biểu đồ dòng tiền năm 2024
        self.slides = [
    ...
    def update_navigation(self):
        """Ẩn/Hiện nút bấm theo logic của bạn"""
    ...
    # --- BIỂU ĐỒ 1: TỔNG TIỀN THEO 15 HẠNG MỤC (2024) ---
    def draw_amount_by_category(self):
        ...
        self.ax.set_title("1. TỔNG TIỀN CHI TIÊU THEO 15 HẠNG MỤC (2024)", fontsize=14, fontweight='bold')
    ...
    # --- BIỂU ĐỒ 2: TỔNG TIỀN THEO 5 LOẠI TÀI KHOẢN (2024) ---
    def draw_amount_by_account(self):
        ...
        self.ax.set_title("2. TỔNG TIỀN THEO 5 LOẠI TÀI KHOẢN (2024)", fontsize=14, fontweight='bold')
    ...
    # --- BIỂU ĐỒ 3: TỔNG TIỀN THEO 6 PHƯƠNG THỨC (2024) ---
    def draw_amount_by_method(self):
        ...
        self.ax.set_title("3. TỔNG TIỀN THEO 6 PHƯƠNG THỨC THANH TOÁN (2024)", fontsize=14, fontweight='bold')
...
def run_money_analysis(file_path):
    try:
        ...
        if df_2024.empty:
            print("Thông báo: Dữ liệu năm 2024 không tồn tại hoặc trống.")
            return

        MoneyVisualizer(df_2024)
