...
class BankingVisualizer:
    ...
    # --- BIỂU ĐỒ 1: TỔNG TIỀN THEO THÁNG (2024) ---
    def draw_monthly_trend_premium(self):
        ...
        self.ax.set_title('PHÂN TÍCH BIẾN ĐỘNG DÒNG TIỀN HÀNG THÁNG (2024)', 
    ...
    # --- BIỂU ĐỒ 2: TIỂU BANG LOLLIPOP (2024) ---
    def draw_state_lollipop(self):
        ...
        self.ax.set_title('TOP 15 TIỂU BANG CÓ TỔNG CHI TIÊU CAO NHẤT (2024)', 
